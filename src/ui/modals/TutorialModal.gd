...
func update_tutorial_slide() -> void:
	...
	match current_tutorial_page:
		1:
			tutorial_desc_lbl.text = "【① ゲームの基本ルール】\n『テスト勉強チキンレース』は、実点と申告点を競い合う勉強チキンレースゲームです（通常プレイは1日間、5日制は5日間）。毎日3時限（または4時限）の自習を行い、カードを引いて勉強成果（実点）を高めます。"
		2:
		...
		5:
			tutorial_desc_lbl.text = "【⑤ 最終答え合わせと勝敗】\nマッチ終了後（通常プレイは1日目の終わり、5日制は5日目の終わり）、全員の「実点」「申告点」「ダウト結果」が黒板で大公開されます！ダウトに成功すれば相手の盛り点をもらえ、失敗すればペナルティを受けます。最終的に最も点数の高い人が合格（優勝）です！"
