...
const TITLE_DESCRIPTIONS: Dictionary = {
	...
	Constants.TITLE_CRAM_GENIUS: "模試でスコア100以上かつ1位を獲得する",
	...
	Constants.TITLE_OVERACHIEVER: "嘘を一度もつかずに高得点（150点以上）を達成する",
	Constants.TITLE_SNIPER: "嘘を一度もつかずに、他プレイヤーへのダウトを2回以上成功させる",
	Constants.TITLE_CHIKEN_HERO: "バースト回数1回以下で超高得点（180点以上）を達成する",
	...
	Constants.TITLE_CHARISMA: "2回以上嘘をつき、一度も見破られずに高得点（100点以上）を達成する",
	Constants.TITLE_TODAI: "1試合で高スコア（200点以上）を達成する",
	Constants.TITLE_LUCKY_SEVEN: "最終スコアの1の位が7の状態で1位を獲得する",
	Constants.TITLE_RED_FAIL: "最終スコアが50点以下で終わる",
	Constants.TITLE_CRAM_HONEST: "嘘を一度もつかずにそこそこの得点（120点以上）を達成する",
